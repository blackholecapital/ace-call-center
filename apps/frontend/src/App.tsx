...
const demoLeads:Lead[]=[
  ...
  {id:"ace-5",firstName:"Demo",lastName:"Lead 05",company:"Sample AI Automation Prospect",selectedProduct:"AI Automations",location:"Tampa Bay",stage:"Provisioning",score:91,source:"ACE AI campaign",callStatus:"Completed",documentStatus:"Signed",deliveryAt:"2026-08-18T14:00:00-04:00",deliveryStatus:"Scheduled",value:12500},
...
export default function App(){
  ...
  async function act(lead:Lead,action:LeadAction){
    ...
    try{
      ...
      if(action==="call"){if(!lead.phone)throw new Error("This prospect has no phone number.");await postJson("/api/calls",{contactId:lead.id});window.alert(`ACE AI is calling ${lead.firstName} now.`);return;}
